...
const LoginForm: React.FC<LoginFormProps> = ({ onSubmit, isLoading = false }) => {
  // Get auth loading state from Redux
  ...
  const isProcessing = combinedLoading || isSubmitting;
  ...
  return (
    <AuthTemplate
      sideTitle="Tăng hiệu suất cuộc họp"
      sideDescription="Đăng nhập để truy cập vào Meobeo.ai - trợ lý ghi meeting note thông minh."
      sideTag="Meobeo.ai"
    >
